 ...
 * @width: gets width.
 * @precision: precision on the specifier
 * @size: Size specifier
 *
 ...
 * @is_negative: List a of argument
 * @ind: character types.
 * @buffer: Buffer arrays to handle the print
 * @flags:  Calculates the active flags
 * @width: gets width.
 ...
 * @ind: Index at which the numbers start on the buffer
 * @buffer: Buffer
 * @flags: Flag
 * @width: width
 * @prec: Precision on the specifier
 ...
 * @ind: Index at which the numbers start in the buffer
